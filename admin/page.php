...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <!--  Body Wrapper -->
  <div class="page-wrapper mt-5" style="background-color: #ccc;" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="card mb-0 w-100 vh-50" id="printable-card" style="background: url(../assets/img/images.jpeg); background-repeat: no-repeat; background-size: cover; background-position: center;">
              ...
              <div class="card-body d-flex mt-1 ">
                  ...
                  <div class="form-group p-2 ms-2 ">
                    <h5>Nome: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($nome); ?></p>
                    <h5>Sexo: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($sexo); ?></p>
                    <h5>Data de Nascimento: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($dataNasc); ?></p>                    
                  </div>
                  
                  <div class="form-group p-2">
                    <h5>Nº Passport: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($id); ?></p>
                    <h5>Entradas: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($entrada); ?></p>
                    <h5>Data da Criação: </h5>
                    <p class="text-dark"><?php echo htmlspecialchars($create); ?></p>
                  </div>
                  
                  <div class="form-group p-2 me-0">
                  <h5>Tipo Visto/Class: </h5>
                  <p class="text-dark"><?php echo htmlspecialchars($tipo); ?></p>
                  <h5>Nacionalidade: </h5>
