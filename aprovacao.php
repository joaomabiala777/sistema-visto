          ...
          <tbody class="table-group-divider">
            ...
            if ($result->num_rows > 0) {
              while ($linha = $result->fetch_assoc()) {
                ...
                if ($estado === 'Aprovado') {
                  $btnVisto = "<a href='emitido.php?id=" . $linha['id']."&
                        imagem=".$linha['foto']."&
                        nome=".$linha['nome']."&
                    ...
                    <button class='btn btn-primary'>Ver o visto</button>
                 </a>";
                } else {
                  $btnVisto = "";
                }
                ...
                echo "
                    <tr>
                        <td>{$linha['id']}</td>
                        <td><img src='./img/{$linha['foto']}' width='80'></td>
                        <td>{$linha['nome']}</td>
                        ...
                        <td>
                            <div class='{$cor} fw-bold'>{$estado}</div>
                            <a href='agenda.php?id={$linha['id']}'><button class='btn btn-success'>Editar</button></a>
                            $btnVisto
                        </td>
                    </tr>
                  ";
